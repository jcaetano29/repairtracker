...
export const ESTADOS = {
  ...
  LISTO_PARA_ENVIO:     { label: "Listo para Envio",      color: "#f59e0b", bg: "#fffbeb", icon: "📦" },
...
export const TRANSICIONES = {
  INGRESADO:            ["LISTO_PARA_ENVIO", "ESPERANDO_APROBACION", "ENTREGADO"],
  LISTO_PARA_ENVIO:     ["EN_TALLER", "ENTREGADO"],
  EN_TALLER:            ["ESPERANDO_APROBACION", "ENTREGADO"],
  ESPERANDO_APROBACION: ["EN_REPARACION", "RECHAZADO", "ENTREGADO"],
  RECHAZADO:            ["LISTO_PARA_RETIRO", "ENTREGADO"],
  EN_REPARACION:        ["LISTO_EN_TALLER", "LISTO_PARA_RETIRO", "ENTREGADO"],
  LISTO_EN_TALLER:      ["LISTO_PARA_RETIRO", "ENTREGADO"],
