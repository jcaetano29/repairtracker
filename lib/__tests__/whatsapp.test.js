  ...
  describe("getConversaciones", () => {
    it("returns conversations ordered by last_message_at desc, with unread computed", async () => {
      ...
      const mockClient = {
        ...
        // Segunda query (v_ordenes_dashboard) para el recordatorio de retiro:
        // sin órdenes listas → no hay recordatorio disponible.
      ...
      expect(result).toEqual([
        { ...mockData[0], unread: true, retiroPendiente: null, recordatorioDisponible: false },
      ]);
