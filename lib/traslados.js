...
// ============================================================
//
// All functions except getCentrosReparacion are server-only (admin client).
// They either write to traslados/ordenes (RLS denies anon writes) or read
// joins on locked tables (clientes/ordenes). getCentrosReparacion reads only
// the open 'sucursales' table and is the only function safe in the browser.
